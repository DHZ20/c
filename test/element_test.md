...
1.  [简答题](#org7999554)
    1.  [分苹果](#orgd1f8e0b)
    2.  [总线问题](#orgd1afc6a)
2.  [下面C语言的输出是什么, 并给出解释](#org5ca3322)
3.  [给出下面C语言程序的输出, 并解释为什么](#orgcf1f9a1)
4.  [下面C语言会输出什么, 并给出解释](#orga22adb9)
5.  [二叉树如下,使用先序遍历的结果是:](#org3f42697)
6.  [二叉搜索树如下, 请问以何种顺序输入无法构造这样的二叉树](#org3e57ef5)
7.  [将如下输入转换为最大堆](#org4dec315)
8.  [将如下输入转换为最小堆](#org9c3f4fe)
9.  [使用直线划分空间](#orged5a7cd)
10. [使用折线划分空间](#org3ea1e48)
11. [打印三角形](#orge0c53e7)
12. [实现atof函数](#org391aa99)
13. [使用栈的数据结构实现队列的功能](#org02abac4)
14. [彩票生成器](#orgcb745de)
